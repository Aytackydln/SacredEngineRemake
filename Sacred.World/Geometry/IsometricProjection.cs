...
public static class IsometricProjection
{
    ...
    /// <summary>
    /// Converts the top-left origin of a rendered terrain tile into the world-coordinate
    /// anchor at the diamond's top vertex.
    /// </summary>
    public static Vector2 TileAnchorOffset => new(HalfStepWidth, 0.0f);
    ...
    public static WorldScreenTransform CreateScreenTransform(
        ...
        int viewportHeight)
    {
        var centerIso = WorldToIso(worldCenter) + TileAnchorOffset;
