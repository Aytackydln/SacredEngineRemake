...
internal sealed class InGameInputController
{
        ...
        Action<bool> setHandCursor)
    {
        ...
        _collision = new WorldCollisionResolver(worldStreamer);
    ...
    public void Update(float deltaSeconds)
    {
        ...
        if (_input.ConsumePressed(VirtualKey.F8))
        {
            ...
            Console.WriteLine($"Debug input: stairs tiles {FormatVisibility(_scene.Debug.StairsMapVisible)}");
        }
        ...
        if (_worldLighting.Update(deltaSeconds, _scene.Lighting, lightingFocus))
            _updateWindowTitle();
        ...
        var mouseWorld = GameActorElevation.ScreenToWorldOnSurface(
            ...
            _viewportWidth(),
            _viewportHeight());
        _setHandCursor(_stairs.IsStairsAt(mouseWorld));
    }
